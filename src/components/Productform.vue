...
<div class="wrapper">
    <Form :validation-schema="productform"  @submit="submitproduct" >
      <div class="form-group">
        ...
        <Field type="text" class="form-control" id="nameproduct" name="name" placeholder="Nhập vào tên sản phẩm" v-model="productLocal.title" />
        <ErrorMessage name="name" class="text-danger" />
      </div>
    <div class="form-group">
        <label for="imgproduct">Ảnh sản phẩm</label>
        <div style="display: flex; flex-direction: row;">
        <Field type="text" class="form-control" id="imgproduct" name="img" placeholder="Nhập link ảnh sản phẩm" v-model="productLocal.img"/>
        </div>
      </div>
      <div class="form-group">
        <label for="priceproduct">Giá sản phẩm</label>
        <Field type="number" class="form-control" id="priceproduct" name="price" placeholder="Nhập vào giá sản phẩm" v-model="productLocal.price" />
      ...
      <div class="form-group">
        ...
        <Field type="text" class="form-control" id="categoryproduct" name="category" placeholder="Nhập loại sản phẩm" v-model="productLocal.categories"/>
