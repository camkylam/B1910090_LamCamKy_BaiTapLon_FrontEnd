...
<div style="margin: 20px 100px;" class="sw">
    <div style="text-align: center; margin: 30px 0;" class="heading">
        <h3>Sản phẩm nổi bật</h3>
    </div>
    <div class="flex-row" style="margin:0 100px;">
        <div class="d-sm-flex flex-wrap">
            <div class="card m-1" style="width: 18rem; border: 1px solid black; background-color: var(#eee);"  v-for="item in Products" v-show="item.categories === 'sản phẩm nổi bật'">
